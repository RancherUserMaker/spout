...
namespace Rancherusermaker\Spout\Writer\XLSX\Helper;

use Rancherusermaker\Spout\Writer\Common\Entity\Worksheet;
use Rancherusermaker\Spout\Writer\Common\Helper\FileSystemWithRootFolderHelperInterface;
 ...
 */
class FileSystemHelper extends \Rancherusermaker\Spout\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    /** @var \Rancherusermaker\Spout\Common\Helper\Escaper\XLSX Used to escape XML data */
    private $escaper;
     ...
     * @param \Rancherusermaker\Spout\Common\Helper\Escaper\XLSX $escaper Used to escape XML data
     */
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create at least one of the base folders
     * @return void
     */
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create the folder
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     * @return FileSystemHelper
     */
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create the file
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to create at least one of the folders
     * @return FileSystemHelper
     */
