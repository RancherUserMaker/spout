...
use Rancherusermaker\Spout\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
    ...
    /**
     * @param \Rancherusermaker\Spout\Common\Helper\GlobalFunctionsHelper $globalFunctionsHelper
     */
     ...
     * @throws \Rancherusermaker\Spout\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
