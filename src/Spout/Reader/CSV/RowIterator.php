...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \Rancherusermaker\Spout\Common\Helper\EncodingHelper Helper to work with different encodings */
    protected $encodingHelper;

    /** @var \Rancherusermaker\Spout\Reader\CSV\Creator\InternalEntityFactory Factory to create entities */
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\EncodingConversionException If unable to convert data to UTF-8
     * @return void
     */
