...
abstract class ReaderAbstract implements ReaderInterface
{
     ...
     *
     * @param  string $filePath Path of the file to be read
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If the file at the given path does not exist, is not readable or is corrupted
     * @return void
     */
     ...
     * Returns an iterator to iterate over sheets.
     *
     * @throws \Rancherusermaker\Spout\Reader\Exception\ReaderNotOpenedException If called before opening the reader
