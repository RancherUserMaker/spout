...
class SheetIterator implements IteratorInterface
{
    ...
    /** @var \Rancherusermaker\Spout\Common\Helper\Escaper\ODS Used to unescape XML data */
    protected $escaper;
     ...
     * @param \Rancherusermaker\Spout\Common\Manager\OptionsManagerInterface $optionsManager
     * @param \Rancherusermaker\Spout\Common\Helper\Escaper\ODS $escaper Used to unescape XML data
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to open the XML file containing sheets' data
     * @return void
     */
     ...
     *
     * @return \Rancherusermaker\Spout\Reader\ODS\Sheet
     */
