...
use Rancherusermaker\Spout\Reader\Common\XMLProcessor;
use Rancherusermaker\Spout\Reader\Exception\InvalidValueException;
...
use Rancherusermaker\Spout\Reader\XLSX\Helper\CellHelper;
...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \Rancherusermaker\Spout\Reader\Common\XMLProcessor Helper Object to process XML nodes */
    protected $xmlProcessor;

    /** @var Helper\CellValueFormatter Helper to format cell values */
    protected $cellValueFormatter;

    /** @var \Rancherusermaker\Spout\Reader\Common\Manager\RowManager Manages rows */
    protected $rowManager;

    /** @var \Rancherusermaker\Spout\Reader\XLSX\Creator\InternalEntityFactory Factory to create entities */
     ...
     *
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If the sheet data XML cannot be read
     * @return void
     */
     ...
     *
     * @throws \Rancherusermaker\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \Rancherusermaker\Spout\Common\Exception\IOException If unable to read the sheet data XML
     * @return void
     */
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<dimension>" starting node
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" node
     * @throws \Rancherusermaker\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" node
     * @throws \Rancherusermaker\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
