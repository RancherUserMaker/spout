...
use Rancherusermaker\Spout\Reader\XLSX\Sheet;
...
class SheetManager
{
    ...
    /** @var \Rancherusermaker\Spout\Common\Manager\OptionsManagerInterface Reader's options manager */
    protected $optionsManager;

    /** @var \Rancherusermaker\Spout\Reader\XLSX\Manager\SharedStringsManager Manages shared strings */
    protected $sharedStringsManager;

    /** @var \Rancherusermaker\Spout\Common\Helper\GlobalFunctionsHelper Helper to work with global functions */
    protected $globalFunctionsHelper;

    /** @var InternalEntityFactory Factory to create entities */
    protected $entityFactory;

    /** @var \Rancherusermaker\Spout\Common\Helper\Escaper\XLSX Used to unescape XML data */
    protected $escaper;
     ...
     * @param \Rancherusermaker\Spout\Common\Manager\OptionsManagerInterface $optionsManager Reader's options manager
     * @param \Rancherusermaker\Spout\Reader\XLSX\Manager\SharedStringsManager $sharedStringsManager Manages shared strings
     * @param \Rancherusermaker\Spout\Common\Helper\Escaper\XLSX $escaper Used to unescape XML data
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookPr>" starting node
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookView>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<sheet>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
     ...
     *
     * @param \Rancherusermaker\Spout\Reader\Wrapper\XMLReader $xmlReaderOnSheetNode XML Reader instance, pointing on the node describing the sheet, as defined in "workbook.xml"
     * @param int $sheetIndexZeroBased Index of the sheet, based on order of appearance in the workbook (zero-based)
     * @param bool $isSheetActive Whether this sheet was defined as active
     * @return \Rancherusermaker\Spout\Reader\XLSX\Sheet Sheet instance
     */
